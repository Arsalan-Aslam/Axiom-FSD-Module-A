...
// Function to generate random word from the words array
...
function decrementTimer() {
    ...
    if ( time === 0 ) {
        // when timer reaches 0, stop the setInterval function timer
...
function gameover() {
    ...
    // update the content to display the gameover container
...
userWord.addEventListener('input', e => {
    ...
    if ( userInput === randomWord ) {
        ...
        if ( difficulty === 'easy') {
            // If the difficulty if easy, increment timer by 3
            time += 3;
        } else if (difficulty === 'medium') {
            // If the difficulty if medium, increment timer by 2
            time += 2;
        } else {
            // If the difficulty if hard, increment timer by 1
            time += 1;
        }
