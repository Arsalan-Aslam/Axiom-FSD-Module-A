...
function displayTransaction (transaction) {
    ...
    // Assign the innerHTML for the transaction li
...
function addTransaction(e) {
    ...
    if ( reason.value.trim() === '' || amount.value.trim() === '') {
        ...
        // Create an object for the transaction containing id, text for the reason, and transaction the amount
        const transaction = {
            id: createID(),
            reason: reason.value,
            amount: +amount.value
...
// Function tp delete transaction from the history
